...
3. **Validation persistence:** preserve policy/catalog/review/ledger versions, structured
...
10. **Validation contract:** before Package 4 implementation, define session/program scope
